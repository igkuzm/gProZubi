...
create_casesWindow (void)
{
  ...
  GLADE_HOOKUP_OBJECT (casesWindow, casesEditFrame, "casesEditFrame");
  GLADE_HOOKUP_OBJECT (casesWindow, alignment1, "alignment1");
  GLADE_HOOKUP_OBJECT (casesWindow, label12, "label12");
