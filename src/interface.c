...
create_mainWindow (void)
{
  ...
  image1 = create_pixmap (mainWindow, "person.circle.png");
...
create_casesWindow (void)
{
  ...
  GtkWidget *vbox4;
  GtkWidget *casesEditToolbar;
  GtkWidget *casesEditWindow;
  GtkWidget *casesEditInfo;
  ...
  casesEditToolbar = gtk_toolbar_new ();
  gtk_widget_show (casesEditToolbar);
  gtk_box_pack_start (GTK_BOX (vbox4), casesEditToolbar, FALSE, FALSE, 0);
  gtk_toolbar_set_style (GTK_TOOLBAR (casesEditToolbar), GTK_TOOLBAR_BOTH);
  tmp_toolbar_icon_size = gtk_toolbar_get_icon_size (GTK_TOOLBAR (casesEditToolbar));
  ...
  casesEditInfo = gtk_label_new ("");
  gtk_widget_show (casesEditInfo);
  gtk_box_pack_start (GTK_BOX (vbox4), casesEditInfo, FALSE, FALSE, 0);
  ...
  GLADE_HOOKUP_OBJECT (casesWindow, casesEditToolbar, "casesEditToolbar");
  GLADE_HOOKUP_OBJECT (casesWindow, casesEditWindow, "casesEditWindow");
  GLADE_HOOKUP_OBJECT (casesWindow, casesEditInfo, "casesEditInfo");
